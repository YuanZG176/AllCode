...
--1. [¼ò´ðÌâ]
--Determine which orders haven¡¯t yet shipped and the name of the customer who placed the order. 
...
SELECT o.order#, c.firstname , c.lastname 
FROM orders o
...
FROM customers c,orders o ,orderitems it,books b
WHERE c.customer# = o.customer# and  o.order#= it.order# and it.isbn=b.isbn
and c.state = 'FL' and b.category ='COMPUTER';

select * from books where category ='COMPUTER';
select * from books where category LIKE '%COMPUTER%';


--SELECT c.customer#, c.lastname, c.firstname
--FROM customers c
--JOIN orders o ON c.customer# = o.customer#
--JOIN orderitems it ON o.order# = it.order#
...
select distinct c.firstname, c.lastname,b.title,c.state,b.category
...
select c.firstname, c.lastname,order#
