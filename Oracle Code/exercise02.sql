...
select title,pubdate from books where category = 'COMPUTER' and pubdate >= '1-1月-05' and pubdate <= '31-12月-05'; 

select title,pubdate from books where category = 'COMPUTER' and pubdate like '%05';

select title,pubdate from books where category = 'COMPUTER' and pubdate between '1-1月-05' and  '31-12月-05'; 
